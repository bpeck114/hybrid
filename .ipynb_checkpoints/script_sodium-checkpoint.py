...
s_sodium = [8.80, 17.61, 35.22, 70.43, 140.86, 281.73, 563.45]
...
def main(output_file, master_file, s_sodium, n_file, integration_time, run_simulation=False):
    # For running photometric Rayleigh simulations
    ...
    for i, rayleigh in enumerate(n_file):
        ...
        sodium_siglev = s_sodium[i]

        # MAOS command
        command = f"maos -o {output_file}/{rayleigh}W -c {master_file} plot.all=1 plot.setup=1 -O 'powfs.siglev=[{sodium_siglev} 1270 64529.03 147933.02]'"
